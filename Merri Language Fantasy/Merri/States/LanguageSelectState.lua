...
function LanguageSelectState:Setup( options )
	...
	StateBase:AddButton( { 
		...
		label 	= { id = "btn_language_en", 	path = "Content/Fonts/PressStart2P.ttf",   			pos_x = 25, pos_y = 25+35, color = 0xFFFFFF, text = "I know English" }
		} )
		
	StateBase:AddButton( { 
		button = { id = "btn_language_eo", 	path = "Content/Graphics/UI/widebtnbg.png",  	pos_x = 15, pos_y = 100  },
		label 	= { id = "btn_language_eo", 	path = "Content/Fonts/PressStart2P.ttf",   			pos_x = 25, pos_y = 100+35, color = 0xFFFFFF, text = "Mi konas Esperanton" }
		} )
		
	StateBase:AddButton( { 
		button = { id = "btn_language_io", 	path = "Content/Graphics/UI/widebtnbg.png",  	pos_x = 15, pos_y = 175  },
		label 	= { id = "btn_language_io", 	path = "Content/Fonts/PressStart2P.ttf",   			pos_x = 25, pos_y = 175+35, color = 0xFFFFFF, text = "Me konas Ido" }
		} )
		
	StateBase:AddButton( { 
		button = { id = "btn_language_es", 	path = "Content/Graphics/UI/widebtnbg.png",  	pos_x = 15, pos_y = 250  },
		label 	= { id = "btn_language_es", 	path = "Content/Fonts/PressStart2P.ttf",   			pos_x = 25, pos_y = 250+35, color = 0xFFFFFF, text = "Yo conozco español" }
		} )
