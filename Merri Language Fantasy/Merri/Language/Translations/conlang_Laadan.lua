...
function SetupEnglish()
    ...
    -- Translations --
    -- * = unsure, approximation
    
    -- CREDITS SCREEN
    helper[ "Translators" ]             = "Héedaná"                    -- Header text: "Translators" for Translator credits section
    helper[ "language-name" ]           = "Láadan"                    -- Name of this language (match this language file)
    helper[ "Translation Credits" ]     = "Rachel J Morris"                    -- Translators, append your name to the list.
    
    helper[ "website" ]                 = "Shenidalehoth:" --*         -- Label for homepage URL
    ...
    -- GAME TITLE
    -- shida = game
    target[ "game title" ]              = "eth shida Láadaneth"    -- *                -- Translate as "Fantasy of ____" for your language. (e.g., Fantazio de Esperanto)
    ...
    -- MAIN MENU BUTTONS
    target[ "play" ]                    = "Elash"                    -- Button to begin the game
    ...
    target[ "help" ]                    = "Den"                    -- Get help / instructions for a game or function
    ...
    target[ "Money" ]                   = "Losh"                    -- The amount of (generic) money you've earned
    target[ "Health" ]                  = "Lam"                    -- Amount of hits you have before you die
    
    -- Messages
    target[ "Game Over" ]               = "Rahu shida" -- *
    ...
    target[ "mushroom" ]                = "Mud"
    target[ "bat" ]                     = ""
    target[ "rabbit" ]                  = "Shanemid"
    target[ "snake" ]                   = "Ezha"
    target[ "skeleton" ]                = ""
    target[ "moose" ]                   = ""
    
    -- Items
    target[ "rock" ]                    = "Ud"                    -- Large stone to break open with a pickaxe
    target[ "star" ]                    = "Ash"
    target[ "sandwich" ]                = ""
    target[ "amethyst" ]                = ""
    target[ "sapphire" ]                = ""
